import { Eye, EyeOff,  Loader2, LockKeyholeIcon, MailQuestionIcon, MessageSquareQuote } from 'lucide-react';
  ...
  return (
      ...
      <div className='min-h-screen grid  lg:grid-cols-2'>
          ...
          <div className='w-full max-w-md space-y-8'>
            <div className='text-center md-8'>
              <div className="flex flex-col items-center  gap-2 group">
                ...
                <h1 className='text-2xl font-bold mt-3'>Lets Create A Buzz</h1>
        ...
        <div className='max-w-md text-center'>
          <img src={Login} className="animate-[grow-shrink_2s_infinite_ease-in-out]"></img>
        <h1 className='text-2xl font-bold mb-4 animate-typing'> Join Our Community </h1>
      <p class="text-base-content/60 "> Connect with Friends, Share Moments and Stay in Touch in Every Aspect of Life</p>
        </div>
        </div>
      </div>
    )
